...
function main() {
  ...
  btn.setAttribute('style', 'background-color: yellow; font-family: cursive; font-size: 25px; width: 250px; height: 70px; padding: 15px; margin: 15px; border-radius: 25px; border: none; display: inline-block');
  document.body.appendChild(btn);

  const select = document.createElement('select');
  const option = document.createElement('option');
  select.setAttribute('style', 'background-color: yellow; font-family: cursive; font-size: 25px; width: 250px; height: 70px; padding: 15px; margin: 15px; border-radius: 25px; outline: none; text-align: center;');
